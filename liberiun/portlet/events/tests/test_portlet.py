...
from liberiun.portlet.events import exampleportlet

from liberiun.portlet.events.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='liberiun.portlet.events.ExamplePortlet')
        self.assertEquals(portlet.addview,
                          'liberiun.portlet.events.ExamplePortlet')
